...
public class PersonalProfileDocumentWeblogInverse extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonalProfileDocumentWeblogInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalProfileDocumentWeblogInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonalProfileDocumentWeblogInverseIterator.getWeblogInverse());
		} catch (Exception e) {
