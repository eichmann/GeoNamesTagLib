...
public class PersonalProfileDocumentSha1Iterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonalProfileDocumentSha1Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalProfileDocumentSha1Iterator.class);
