...
public class FeatureAltIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static FeatureAltIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FeatureAltIterator.class);
