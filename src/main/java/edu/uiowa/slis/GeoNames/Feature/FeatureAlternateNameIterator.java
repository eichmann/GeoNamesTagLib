...
public class FeatureAlternateNameIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static FeatureAlternateNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FeatureAlternateNameIterator.class);
