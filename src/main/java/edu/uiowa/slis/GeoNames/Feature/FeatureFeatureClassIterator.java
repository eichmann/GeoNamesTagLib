...
public class FeatureFeatureClassIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static FeatureFeatureClassIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FeatureFeatureClassIterator.class);
