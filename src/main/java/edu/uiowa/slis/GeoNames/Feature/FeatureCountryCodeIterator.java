...
public class FeatureCountryCodeIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static FeatureCountryCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FeatureCountryCodeIterator.class);
