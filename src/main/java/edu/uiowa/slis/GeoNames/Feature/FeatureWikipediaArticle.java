...
public class FeatureWikipediaArticle extends edu.uiowa.slis.GeoNames.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		try {
			FeatureWikipediaArticleIterator theFeature = (FeatureWikipediaArticleIterator)findAncestorWithClass(this, FeatureWikipediaArticleIterator.class);
			pageContext.getOut().print(theFeature.getWikipediaArticle());
		} catch (Exception e) {
