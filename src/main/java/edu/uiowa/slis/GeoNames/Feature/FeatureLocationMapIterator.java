...
public class FeatureLocationMapIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static FeatureLocationMapIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FeatureLocationMapIterator.class);
