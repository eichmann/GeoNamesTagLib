...
public class FeatureNearbyFeaturesType extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static FeatureNearbyFeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(FeatureNearbyFeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFeatureNearbyFeaturesIterator.getType());
		} catch (Exception e) {
