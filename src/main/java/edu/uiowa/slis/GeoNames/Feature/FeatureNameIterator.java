...
public class FeatureNameIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static FeatureNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FeatureNameIterator.class);
