...
public class FeaturePostalCodeIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static FeaturePostalCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FeaturePostalCodeIterator.class);
