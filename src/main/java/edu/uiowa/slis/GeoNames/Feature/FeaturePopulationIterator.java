...
public class FeaturePopulationIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static FeaturePopulationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FeaturePopulationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://www.geonames.org/ontology#population> ?s } ");
			if(rs.hasNext()) {
				QuerySolution sol = rs.nextSolution();
				population = sol.get("?s").toString();
				firstInstance = true;
	...
	public  void setPopulation(String thePopulation) {
