...
public class FeatureNearbyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static FeatureNearbyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FeatureNearbyIterator.class);
