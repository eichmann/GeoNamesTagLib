...
public class FeatureIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static FeatureIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FeatureIterator.class);
