...
public class FeatureFeatureClass extends edu.uiowa.slis.GeoNames.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		try {
			FeatureFeatureClassIterator theFeature = (FeatureFeatureClassIterator)findAncestorWithClass(this, FeatureFeatureClassIterator.class);
			pageContext.getOut().print(theFeature.getFeatureClass());
		} catch (Exception e) {
