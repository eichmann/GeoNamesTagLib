...
public class FeatureNeighbouringFeatures extends edu.uiowa.slis.GeoNames.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		try {
			FeatureNeighbouringFeaturesIterator theFeature = (FeatureNeighbouringFeaturesIterator)findAncestorWithClass(this, FeatureNeighbouringFeaturesIterator.class);
			pageContext.getOut().print(theFeature.getNeighbouringFeatures());
		} catch (Exception e) {
