...
public class FeatureLatIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static FeatureLatIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FeatureLatIterator.class);
