...
public class FeatureParentADM4 extends edu.uiowa.slis.GeoNames.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		try {
			FeatureParentADM4Iterator theFeature = (FeatureParentADM4Iterator)findAncestorWithClass(this, FeatureParentADM4Iterator.class);
			pageContext.getOut().print(theFeature.getParentADM4());
		} catch (Exception e) {
