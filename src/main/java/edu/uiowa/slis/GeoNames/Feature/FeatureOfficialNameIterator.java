...
public class FeatureOfficialNameIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static FeatureOfficialNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FeatureOfficialNameIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://www.geonames.org/ontology#officialName> ?s } ");
			if(rs.hasNext()) {
				QuerySolution sol = rs.nextSolution();
				officialName = sol.get("?s").toString();
				firstInstance = true;
	...
	public  void setOfficialName(String theOfficialName) {
		officialName = theOfficialName;
	}
