...
public class OnlineChatAccountDepictionIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineChatAccountDepictionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineChatAccountDepictionIterator.class);
