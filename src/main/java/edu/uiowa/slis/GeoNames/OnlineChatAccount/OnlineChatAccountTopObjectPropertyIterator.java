...
public class OnlineChatAccountTopObjectPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineChatAccountTopObjectPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineChatAccountTopObjectPropertyIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://www.w3.org/2002/07/owl#topObjectProperty> ?s } ");
			if(rs.hasNext()) {
