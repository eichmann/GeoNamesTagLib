...
public class OnlineChatAccountTopDataPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineChatAccountTopDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineChatAccountTopDataPropertyIterator.class);
