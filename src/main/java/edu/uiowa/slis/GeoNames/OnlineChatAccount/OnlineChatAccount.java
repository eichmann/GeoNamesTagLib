...
public class OnlineChatAccount extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineChatAccount currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineChatAccount.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			OnlineChatAccountIterator theOnlineChatAccountIterator = (OnlineChatAccountIterator) findAncestorWithClass(this, OnlineChatAccountIterator.class);

			if (theOnlineChatAccountIterator != null) {
				subjectURI = theOnlineChatAccountIterator.getSubjectURI();
				label = theOnlineChatAccountIterator.getLabel();
			}

			if (theOnlineChatAccountIterator == null && subjectURI == null) {
			...
			log.error("Exception raised in OnlineChatAccount doStartTag", e);
			throw new JspTagException("Exception raised in OnlineChatAccount doStartTag");
		} finally {
			freeConnection();
		}
