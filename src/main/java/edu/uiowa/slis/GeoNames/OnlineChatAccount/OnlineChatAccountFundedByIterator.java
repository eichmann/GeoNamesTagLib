...
public class OnlineChatAccountFundedByIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineChatAccountFundedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineChatAccountFundedByIterator.class);
