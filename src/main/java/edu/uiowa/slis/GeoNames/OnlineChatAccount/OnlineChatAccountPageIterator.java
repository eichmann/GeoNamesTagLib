...
public class OnlineChatAccountPageIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineChatAccountPageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineChatAccountPageIterator.class);
