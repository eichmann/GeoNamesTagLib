...
public class OnlineChatAccountSameAsIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineChatAccountSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineChatAccountSameAsIterator.class);
