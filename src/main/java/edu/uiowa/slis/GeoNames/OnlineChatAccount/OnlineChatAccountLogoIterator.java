...
public class OnlineChatAccountLogoIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineChatAccountLogoIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineChatAccountLogoIterator.class);
