...
public class OnlineChatAccountDifferentFromIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineChatAccountDifferentFromIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineChatAccountDifferentFromIterator.class);
