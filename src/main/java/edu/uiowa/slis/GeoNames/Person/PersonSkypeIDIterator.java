...
public class PersonSkypeIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonSkypeIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonSkypeIDIterator.class);
