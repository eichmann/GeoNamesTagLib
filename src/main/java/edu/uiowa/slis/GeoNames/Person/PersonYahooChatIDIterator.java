...
public class PersonYahooChatIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonYahooChatIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonYahooChatIDIterator.class);
