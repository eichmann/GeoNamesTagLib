...
public class PersonOpenidIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonOpenidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonOpenidIterator.class);
