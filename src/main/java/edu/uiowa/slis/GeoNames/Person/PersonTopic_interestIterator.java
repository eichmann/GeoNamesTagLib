...
public class PersonTopic_interestIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonTopic_interestIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonTopic_interestIterator.class);
