...
public class PersonMbox_sha1sumIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonMbox_sha1sumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonMbox_sha1sumIterator.class);
