...
public class PersonLongIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonLongIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonLongIterator.class);
