...
public class PersonMboxIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonMboxIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonMboxIterator.class);
