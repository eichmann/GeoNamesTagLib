...
public class PersonMadeIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonMadeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonMadeIterator.class);
