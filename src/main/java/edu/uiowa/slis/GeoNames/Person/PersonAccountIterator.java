...
public class PersonAccountIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonAccountIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonAccountIterator.class);
