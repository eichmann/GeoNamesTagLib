...
public class PersonIcqChatIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonIcqChatIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonIcqChatIDIterator.class);
