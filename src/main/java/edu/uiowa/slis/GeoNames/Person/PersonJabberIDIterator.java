...
public class PersonJabberIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonJabberIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonJabberIDIterator.class);
