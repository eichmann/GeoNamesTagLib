...
public class PersonHoldsAccountIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonHoldsAccountIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonHoldsAccountIterator.class);
