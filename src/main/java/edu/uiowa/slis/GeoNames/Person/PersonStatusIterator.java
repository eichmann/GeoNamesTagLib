...
public class PersonStatusIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonStatusIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonStatusIterator.class);
