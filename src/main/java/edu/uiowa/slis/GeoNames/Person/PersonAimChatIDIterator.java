...
public class PersonAimChatIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonAimChatIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonAimChatIDIterator.class);
