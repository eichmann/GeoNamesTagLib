...
public class PersonInterestIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonInterestIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonInterestIterator.class);
