...
public class PersonWeblogIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonWeblogIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonWeblogIterator.class);
