...
public class PersonTipjarIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonTipjarIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonTipjarIterator.class);
