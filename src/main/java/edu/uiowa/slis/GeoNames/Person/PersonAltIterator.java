...
public class PersonAltIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static PersonAltIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonAltIterator.class);
