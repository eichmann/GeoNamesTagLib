...
public class ClassIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ClassIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClassIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://www.geonames.org/ontology#Class> . "+
