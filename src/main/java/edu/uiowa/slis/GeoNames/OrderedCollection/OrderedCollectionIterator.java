...
public class OrderedCollectionIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OrderedCollectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrderedCollectionIterator.class);
