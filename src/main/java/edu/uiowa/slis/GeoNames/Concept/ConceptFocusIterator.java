...
public class ConceptFocusIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ConceptFocusIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConceptFocusIterator.class);
