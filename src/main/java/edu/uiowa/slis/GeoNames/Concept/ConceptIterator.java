...
public class ConceptIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ConceptIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConceptIterator.class);
