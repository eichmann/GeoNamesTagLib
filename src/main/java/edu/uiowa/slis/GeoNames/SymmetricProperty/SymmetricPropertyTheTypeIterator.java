...
public class SymmetricPropertyTheTypeIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static SymmetricPropertyTheTypeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SymmetricPropertyTheTypeIterator.class);
