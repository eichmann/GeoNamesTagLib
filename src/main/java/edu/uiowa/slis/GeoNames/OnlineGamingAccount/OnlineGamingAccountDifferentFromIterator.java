...
public class OnlineGamingAccountDifferentFromIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineGamingAccountDifferentFromIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineGamingAccountDifferentFromIterator.class);
