...
public class OnlineGamingAccount extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineGamingAccount currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineGamingAccount.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			OnlineGamingAccountIterator theOnlineGamingAccountIterator = (OnlineGamingAccountIterator) findAncestorWithClass(this, OnlineGamingAccountIterator.class);

			if (theOnlineGamingAccountIterator != null) {
				subjectURI = theOnlineGamingAccountIterator.getSubjectURI();
				label = theOnlineGamingAccountIterator.getLabel();
			}

			if (theOnlineGamingAccountIterator == null && subjectURI == null) {
			...
			log.error("Exception raised in OnlineGamingAccount doStartTag", e);
			throw new JspTagException("Exception raised in OnlineGamingAccount doStartTag");
		} finally {
			freeConnection();
		}
