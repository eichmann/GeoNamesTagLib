...
public class OnlineGamingAccountBottomDataPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineGamingAccountBottomDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineGamingAccountBottomDataPropertyIterator.class);
