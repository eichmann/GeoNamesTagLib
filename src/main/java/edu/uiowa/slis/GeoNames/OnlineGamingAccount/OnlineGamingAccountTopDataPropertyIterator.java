...
public class OnlineGamingAccountTopDataPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineGamingAccountTopDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineGamingAccountTopDataPropertyIterator.class);
