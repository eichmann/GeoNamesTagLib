...
public class OnlineGamingAccountAccountNameIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineGamingAccountAccountNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineGamingAccountAccountNameIterator.class);
