...
public class OnlineGamingAccountThemeIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineGamingAccountThemeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineGamingAccountThemeIterator.class);
