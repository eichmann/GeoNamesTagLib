...
public class WikipediaArticleTopicIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static WikipediaArticleTopicIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WikipediaArticleTopicIterator.class);
