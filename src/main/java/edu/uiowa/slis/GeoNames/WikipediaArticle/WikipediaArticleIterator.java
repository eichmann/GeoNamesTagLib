...
public class WikipediaArticleIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static WikipediaArticleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WikipediaArticleIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://www.geonames.org/ontology#WikipediaArticle> . "+
