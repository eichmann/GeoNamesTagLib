...
public class WikipediaArticleInterestInverseType extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static WikipediaArticleInterestInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(WikipediaArticleInterestInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWikipediaArticleInterestInverseIterator.getType());
		} catch (Exception e) {
