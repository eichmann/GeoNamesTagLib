...
public class WikipediaArticlePrimaryTopicIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static WikipediaArticlePrimaryTopicIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WikipediaArticlePrimaryTopicIterator.class);
