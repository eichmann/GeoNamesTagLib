...
public class ObjectPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ObjectPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertyIterator.class);
