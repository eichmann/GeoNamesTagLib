...
public class ObjectPropertyCommentIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ObjectPropertyCommentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertyCommentIterator.class);
