...
public class ObjectPropertyTheTypeIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ObjectPropertyTheTypeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertyTheTypeIterator.class);
