...
public class OrganizationStatusIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OrganizationStatusIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationStatusIterator.class);
