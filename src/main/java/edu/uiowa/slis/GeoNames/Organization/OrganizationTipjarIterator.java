...
public class OrganizationTipjarIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OrganizationTipjarIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationTipjarIterator.class);
