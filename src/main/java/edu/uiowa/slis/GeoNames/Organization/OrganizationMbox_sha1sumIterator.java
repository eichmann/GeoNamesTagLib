...
public class OrganizationMbox_sha1sumIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OrganizationMbox_sha1sumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationMbox_sha1sumIterator.class);
