...
public class OrganizationSkypeIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OrganizationSkypeIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationSkypeIDIterator.class);
