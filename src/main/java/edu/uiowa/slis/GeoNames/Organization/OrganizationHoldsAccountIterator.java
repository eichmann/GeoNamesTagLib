...
public class OrganizationHoldsAccountIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OrganizationHoldsAccountIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationHoldsAccountIterator.class);
