...
public class GroupWeblogIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GroupWeblogIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupWeblogIterator.class);
