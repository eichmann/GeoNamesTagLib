...
public class GroupAimChatIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GroupAimChatIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupAimChatIDIterator.class);
