...
public class GroupAccountIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GroupAccountIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupAccountIterator.class);
