...
public class GroupMsnChatIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GroupMsnChatIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupMsnChatIDIterator.class);
