...
public class GroupMadeIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GroupMadeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupMadeIterator.class);
