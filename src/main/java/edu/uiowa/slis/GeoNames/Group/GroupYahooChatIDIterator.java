...
public class GroupYahooChatIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GroupYahooChatIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupYahooChatIDIterator.class);
