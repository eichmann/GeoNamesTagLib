...
public class GroupIcqChatIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GroupIcqChatIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupIcqChatIDIterator.class);
