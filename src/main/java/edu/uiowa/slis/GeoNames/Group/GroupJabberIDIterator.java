...
public class GroupJabberIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GroupJabberIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupJabberIDIterator.class);
