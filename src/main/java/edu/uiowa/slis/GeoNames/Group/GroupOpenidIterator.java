...
public class GroupOpenidIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GroupOpenidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupOpenidIterator.class);
