...
public class GroupInterestIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GroupInterestIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupInterestIterator.class);
