...
public class RDFDataIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static RDFDataIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RDFDataIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://www.geonames.org/ontology#RDFData> . "+
