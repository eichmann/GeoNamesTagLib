...
public class CodeDefinitionIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static CodeDefinitionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeDefinitionIterator.class);
