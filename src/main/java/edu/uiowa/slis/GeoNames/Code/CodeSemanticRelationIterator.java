...
public class CodeSemanticRelationIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static CodeSemanticRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeSemanticRelationIterator.class);
