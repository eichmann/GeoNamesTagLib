...
public class AgentOpenidIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentOpenidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentOpenidIterator.class);
