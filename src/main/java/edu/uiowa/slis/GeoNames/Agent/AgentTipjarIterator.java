...
public class AgentTipjarIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentTipjarIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentTipjarIterator.class);
