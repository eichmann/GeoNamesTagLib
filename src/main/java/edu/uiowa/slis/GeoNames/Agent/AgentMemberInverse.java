...
public class AgentMemberInverse extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentMemberInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentMemberInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAgentMemberInverseIterator.getMemberInverse());
		} catch (Exception e) {
