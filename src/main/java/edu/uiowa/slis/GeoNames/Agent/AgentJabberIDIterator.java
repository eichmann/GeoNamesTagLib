...
public class AgentJabberIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentJabberIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentJabberIDIterator.class);
