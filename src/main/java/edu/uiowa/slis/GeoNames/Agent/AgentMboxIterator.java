...
public class AgentMboxIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentMboxIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentMboxIterator.class);
