...
public class AgentMsnChatIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentMsnChatIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentMsnChatIDIterator.class);
