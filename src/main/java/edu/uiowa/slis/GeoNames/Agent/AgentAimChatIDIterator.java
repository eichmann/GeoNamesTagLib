...
public class AgentAimChatIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentAimChatIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentAimChatIDIterator.class);
