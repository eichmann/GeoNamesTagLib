...
public class AgentMadeIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentMadeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentMadeIterator.class);
