...
public class AgentYahooChatIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentYahooChatIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentYahooChatIDIterator.class);
