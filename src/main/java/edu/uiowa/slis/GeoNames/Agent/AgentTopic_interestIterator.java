...
public class AgentTopic_interestIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentTopic_interestIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentTopic_interestIterator.class);
