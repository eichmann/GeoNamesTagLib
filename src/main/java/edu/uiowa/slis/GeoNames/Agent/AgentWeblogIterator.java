...
public class AgentWeblogIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentWeblogIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentWeblogIterator.class);
