...
public class AgentSkypeIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentSkypeIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentSkypeIDIterator.class);
