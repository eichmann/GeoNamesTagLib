...
public class AgentStatusIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentStatusIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentStatusIterator.class);
