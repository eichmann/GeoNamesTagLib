...
public class AgentAccountIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentAccountIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentAccountIterator.class);
