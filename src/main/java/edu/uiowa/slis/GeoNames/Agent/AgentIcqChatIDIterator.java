...
public class AgentIcqChatIDIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static AgentIcqChatIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentIcqChatIDIterator.class);
