...
public class DocumentSha1Iterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static DocumentSha1Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentSha1Iterator.class);
