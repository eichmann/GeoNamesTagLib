...
public class DocumentTopicIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static DocumentTopicIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentTopicIterator.class);
