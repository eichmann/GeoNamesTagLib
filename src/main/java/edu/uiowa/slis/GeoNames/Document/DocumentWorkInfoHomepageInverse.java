...
public class DocumentWorkInfoHomepageInverse extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static DocumentWorkInfoHomepageInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentWorkInfoHomepageInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentWorkInfoHomepageInverseIterator.getWorkInfoHomepageInverse());
		} catch (Exception e) {
