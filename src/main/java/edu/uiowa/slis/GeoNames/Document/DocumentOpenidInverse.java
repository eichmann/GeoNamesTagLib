...
public class DocumentOpenidInverse extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static DocumentOpenidInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentOpenidInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentOpenidInverseIterator.getOpenidInverse());
		} catch (Exception e) {
