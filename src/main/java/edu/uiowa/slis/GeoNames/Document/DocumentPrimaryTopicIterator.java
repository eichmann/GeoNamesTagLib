...
public class DocumentPrimaryTopicIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static DocumentPrimaryTopicIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPrimaryTopicIterator.class);
