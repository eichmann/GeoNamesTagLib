...
public class ThingHomepageIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ThingHomepageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingHomepageIterator.class);
