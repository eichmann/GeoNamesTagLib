...
public class ThingBottomObjectPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ThingBottomObjectPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingBottomObjectPropertyIterator.class);
