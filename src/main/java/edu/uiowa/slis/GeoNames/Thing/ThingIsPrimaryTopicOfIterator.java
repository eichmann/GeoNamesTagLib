...
public class ThingIsPrimaryTopicOfIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ThingIsPrimaryTopicOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingIsPrimaryTopicOfIterator.class);
