...
public class ThingTopObjectPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ThingTopObjectPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingTopObjectPropertyIterator.class);
