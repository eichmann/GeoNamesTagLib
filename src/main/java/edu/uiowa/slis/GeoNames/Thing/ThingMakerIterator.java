...
public class ThingMakerIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ThingMakerIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingMakerIterator.class);
