...
public class ThingNameIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ThingNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameIterator.class);
