...
public class ThingIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ThingIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://www.w3.org/2002/07/owl#Thing> . "+
