...
public class ThingThemeIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ThingThemeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingThemeIterator.class);
