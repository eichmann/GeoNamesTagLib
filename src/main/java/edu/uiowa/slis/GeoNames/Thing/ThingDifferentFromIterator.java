...
public class ThingDifferentFromIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ThingDifferentFromIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingDifferentFromIterator.class);
