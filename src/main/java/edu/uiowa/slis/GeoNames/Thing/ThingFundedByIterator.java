...
public class ThingFundedByIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ThingFundedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingFundedByIterator.class);
