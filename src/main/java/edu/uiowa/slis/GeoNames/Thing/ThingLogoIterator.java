...
public class ThingLogoIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ThingLogoIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingLogoIterator.class);
