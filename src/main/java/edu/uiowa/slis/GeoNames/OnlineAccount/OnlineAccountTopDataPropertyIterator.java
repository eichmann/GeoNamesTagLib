...
public class OnlineAccountTopDataPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineAccountTopDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineAccountTopDataPropertyIterator.class);
