...
public class OnlineAccountAccountNameIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineAccountAccountNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineAccountAccountNameIterator.class);
