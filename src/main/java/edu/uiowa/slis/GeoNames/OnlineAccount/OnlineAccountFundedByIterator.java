...
public class OnlineAccountFundedByIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineAccountFundedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineAccountFundedByIterator.class);
