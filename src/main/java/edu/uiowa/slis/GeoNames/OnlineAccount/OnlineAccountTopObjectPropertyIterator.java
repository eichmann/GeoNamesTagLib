...
public class OnlineAccountTopObjectPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineAccountTopObjectPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineAccountTopObjectPropertyIterator.class);
