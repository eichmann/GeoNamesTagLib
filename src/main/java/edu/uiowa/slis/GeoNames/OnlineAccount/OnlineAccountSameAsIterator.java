...
public class OnlineAccountSameAsIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineAccountSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineAccountSameAsIterator.class);
