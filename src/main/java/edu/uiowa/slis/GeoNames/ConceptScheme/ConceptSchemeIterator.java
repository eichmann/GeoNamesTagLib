...
public class ConceptSchemeIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ConceptSchemeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConceptSchemeIterator.class);
