...
public class DatatypePropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static DatatypePropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatatypePropertyIterator.class);
