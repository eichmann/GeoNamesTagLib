...
public class NothingDepictionIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static NothingDepictionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NothingDepictionIterator.class);
