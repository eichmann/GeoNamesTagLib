...
public class NothingMakerIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static NothingMakerIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NothingMakerIterator.class);
