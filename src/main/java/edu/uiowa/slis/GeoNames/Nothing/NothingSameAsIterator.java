...
public class NothingSameAsIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static NothingSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NothingSameAsIterator.class);
