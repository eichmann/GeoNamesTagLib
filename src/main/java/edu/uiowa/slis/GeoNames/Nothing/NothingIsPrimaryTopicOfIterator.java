...
public class NothingIsPrimaryTopicOfIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static NothingIsPrimaryTopicOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NothingIsPrimaryTopicOfIterator.class);
