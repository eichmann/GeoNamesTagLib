...
public class NothingBottomObjectPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static NothingBottomObjectPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NothingBottomObjectPropertyIterator.class);
