...
public class NothingBottomDataPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static NothingBottomDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NothingBottomDataPropertyIterator.class);
