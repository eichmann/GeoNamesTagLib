...
public class NothingDifferentFromIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static NothingDifferentFromIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NothingDifferentFromIterator.class);
