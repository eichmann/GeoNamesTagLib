...
public class ImageIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ImageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageIterator.class);
