...
public class ImageSchoolHomepageInverseType extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ImageSchoolHomepageInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageSchoolHomepageInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theImageSchoolHomepageInverseIterator.getType());
		} catch (Exception e) {
