...
public class ImageTopicIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ImageTopicIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageTopicIterator.class);
