...
public class ImageWeblogInverseType extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ImageWeblogInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageWeblogInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theImageWeblogInverseIterator.getType());
		} catch (Exception e) {
