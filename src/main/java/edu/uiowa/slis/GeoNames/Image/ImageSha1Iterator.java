...
public class ImageSha1Iterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ImageSha1Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageSha1Iterator.class);
