...
public class ImagePublicationsInverse extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static ImagePublicationsInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ImagePublicationsInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theImagePublicationsInverseIterator.getPublicationsInverse());
		} catch (Exception e) {
