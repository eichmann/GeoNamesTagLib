...
public class OntologyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OntologyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OntologyIterator.class);
