...
public class MapLocationMapInverseType extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static MapLocationMapInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(MapLocationMapInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMapLocationMapInverseIterator.getType());
		} catch (Exception e) {
