...
public class MapWeblogInverseType extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static MapWeblogInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(MapWeblogInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMapWeblogInverseIterator.getType());
		} catch (Exception e) {
