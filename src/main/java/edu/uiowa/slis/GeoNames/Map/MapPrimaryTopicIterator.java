...
public class MapPrimaryTopicIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static MapPrimaryTopicIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapPrimaryTopicIterator.class);
