...
public class MapIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static MapIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://www.geonames.org/ontology#Map> . "+
