...
public class GeonamesFeatureShortNameIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeatureShortNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeatureShortNameIterator.class);
