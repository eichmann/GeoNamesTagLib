...
public class GeonamesFeatureParentADM2Iterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeatureParentADM2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeatureParentADM2Iterator.class);
