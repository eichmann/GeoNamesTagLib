...
public class GeonamesFeatureFeatureCodeIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeatureFeatureCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeatureFeatureCodeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://www.geonames.org/ontology#featureCode> ?s } ");
			if(rs.hasNext()) {
