...
public class GeonamesFeatureNeighbourIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeatureNeighbourIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeatureNeighbourIterator.class);
