...
public class GeonamesFeaturePostalCodeIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeaturePostalCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeaturePostalCodeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://www.geonames.org/ontology#postalCode> ?s } ");
			if(rs.hasNext()) {
