...
public class GeonamesFeatureNameIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeatureNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeatureNameIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://www.geonames.org/ontology#name> ?s } ");
			if(rs.hasNext()) {
