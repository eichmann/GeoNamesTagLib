...
public class GeonamesFeatureParentADM1Iterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeatureParentADM1Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeatureParentADM1Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://www.geonames.org/ontology#parentADM1> ?s } ");
			if(rs.hasNext()) {
