...
public class GeonamesFeatureIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeatureIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeatureIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://www.geonames.org/ontology#GeonamesFeature> . "+
