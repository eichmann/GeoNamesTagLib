...
public class GeonamesFeaturePopulationIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeaturePopulationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeaturePopulationIterator.class);
