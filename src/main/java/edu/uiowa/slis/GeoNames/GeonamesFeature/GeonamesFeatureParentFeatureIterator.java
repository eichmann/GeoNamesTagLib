...
public class GeonamesFeatureParentFeatureIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeatureParentFeatureIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeatureParentFeatureIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://www.geonames.org/ontology#parentFeature> ?s } ");
			if(rs.hasNext()) {
