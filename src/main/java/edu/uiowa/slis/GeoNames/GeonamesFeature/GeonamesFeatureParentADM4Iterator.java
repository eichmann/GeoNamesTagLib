...
public class GeonamesFeatureParentADM4Iterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeatureParentADM4Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeatureParentADM4Iterator.class);
