...
public class GeonamesFeatureChildrenFeaturesIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeatureChildrenFeaturesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeatureChildrenFeaturesIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://www.geonames.org/ontology#childrenFeatures> ?s } ");
			if(rs.hasNext()) {
