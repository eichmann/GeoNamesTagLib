...
public class GeonamesFeatureLongIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeatureLongIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeatureLongIterator.class);
