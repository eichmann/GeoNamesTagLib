...
public class GeonamesFeatureOfficialNameIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeatureOfficialNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeatureOfficialNameIterator.class);
