...
public class GeonamesFeatureNeighbouringFeaturesIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static GeonamesFeatureNeighbouringFeaturesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeonamesFeatureNeighbouringFeaturesIterator.class);
