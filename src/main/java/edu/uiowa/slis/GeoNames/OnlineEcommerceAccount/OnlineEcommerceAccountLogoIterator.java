...
public class OnlineEcommerceAccountLogoIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineEcommerceAccountLogoIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineEcommerceAccountLogoIterator.class);
