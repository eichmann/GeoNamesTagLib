...
public class OnlineEcommerceAccountAccountServiceHomepageIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineEcommerceAccountAccountServiceHomepageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineEcommerceAccountAccountServiceHomepageIterator.class);
