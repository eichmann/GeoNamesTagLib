...
public class OnlineEcommerceAccountBottomDataPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineEcommerceAccountBottomDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineEcommerceAccountBottomDataPropertyIterator.class);
