...
public class OnlineEcommerceAccountNameIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineEcommerceAccountNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineEcommerceAccountNameIterator.class);
