...
public class OnlineEcommerceAccountIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineEcommerceAccountIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineEcommerceAccountIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://xmlns.com/foaf/0.1/OnlineEcommerceAccount> . "+
