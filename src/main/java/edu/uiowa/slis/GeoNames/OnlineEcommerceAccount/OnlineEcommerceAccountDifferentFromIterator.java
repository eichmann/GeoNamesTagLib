...
public class OnlineEcommerceAccountDifferentFromIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineEcommerceAccountDifferentFromIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineEcommerceAccountDifferentFromIterator.class);
