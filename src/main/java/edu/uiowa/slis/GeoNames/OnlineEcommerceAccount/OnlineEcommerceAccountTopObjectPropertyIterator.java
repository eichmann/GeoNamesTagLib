...
public class OnlineEcommerceAccountTopObjectPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineEcommerceAccountTopObjectPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineEcommerceAccountTopObjectPropertyIterator.class);
