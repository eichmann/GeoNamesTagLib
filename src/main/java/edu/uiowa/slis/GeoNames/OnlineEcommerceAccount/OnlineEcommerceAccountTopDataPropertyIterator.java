...
public class OnlineEcommerceAccountTopDataPropertyIterator extends edu.uiowa.slis.GeoNames.TagLibSupport {
	static OnlineEcommerceAccountTopDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OnlineEcommerceAccountTopDataPropertyIterator.class);
